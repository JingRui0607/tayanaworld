<%@ Page Title="" Language="C#" MasterPageFile="~/Tayana.Master" AutoEventWireup="true" CodeBehind="Overview.aspx.cs" Inherits="TayanaProject.Overview" %>
    ...
    <div class="right">
        <div class="right1">
            <div class="title">
                ...
                <span id="rightYachtsName" runat="server" clientidmode="Static"></span><span id="spanname" runat="server" style='color: red' clientidmode="Static"></span>
            </div>
            <div class="menu_y">
                <ul>
            ...
            <div class="box1" id="yacht001" runat="server">
            </div>

            <div class="box3">
                <h4><span id="rightYachtsName1" runat="server"></span>DIMENSIONS</h4>
                <div id="yacht002" runat="server"></div>


            </div>
            <p class="topbuttom">
                <img src="tayana/images/top.gif" alt="top" />
            </p>
            ...
            <div class="downloads">
                <p>
                    <img src="tayana/images/downloads.gif" alt="&quot;&quot;" />
                </p>
                <ul>
                    ...
                    <asp:Repeater ID="Repeater_download" runat="server">
                        ...
                        <ItemTemplate>
                            <li>
                                ...
                                <a href='<%# "sys/uploadfile/Yachts_DownLoad/"+ Eval("DownloadName") %>'><%# Eval("YachtsName") %> - <%# Eval("ROW_ID") %> </a>
