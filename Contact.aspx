<%@ Page Title="" Language="C#" MasterPageFile="~/Tayana.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="TayanaProject.Contact" %>
            ...
            <div class="from01">
                ...
                <table>
                    <tr>
                        ...
                        <td><span>*</span><input type="text" runat="server" name="textfield" id="textfieldname" />
                        </td>
                    </tr>
                    <tr>
                        <td class="from01td01">Email :</td>
                        <td><span>*</span><input type="text" runat="server" name="textfield" id="textfieldEmail" /></td>
                    </tr>
                    <tr>
                        <td class="from01td01">Phone :</td>
                        <td><span>*</span><input type="text" runat="server" name="textfield" id="textfieldphone" /></td>
                    </tr>
                    <tr>
                        <td class="from01td01">Country :</td>
                        <td><span>*</span>
                            <select name="select" runat="server" id="selectCountry">
                            </select>
                            <%-- <asp:DropDownList ID="selectCountry" runat="server"></asp:DropDownList>--%></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="select" runat="server" id="selectYachts">
                            </select>
                            <%-- <asp:DropDownList ID="selectYachts" runat="server"></asp:DropDownList>--%>
                        </td>
                    </tr>
                    <tr>
                        <td class="from01td01">Comments:</td>
                        <td>
                            <textarea name="textarea" id="textarea" runat="server"
                                cols="45" rows="5"></textarea></td>
                    </tr>
                    <tr>
                        <td class="from01td01">&nbsp;</td>
                        <td class="f_right">
                            <asp:ImageButton ID="ImageButton1" runat="server" src="tayana/images/buttom03.gif" Width="59" Height="25" OnClick="ImageButton1_Click" />
                        </td>
                    </tr>
                </table>
            </div>
