<%@ Page Title="" Language="C#" MasterPageFile="~/Tayana.Master" AutoEventWireup="true" CodeBehind="Layout.aspx.cs" Inherits="TayanaProject.Layout" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentRight" runat="server">
    ...
    <div class="right">
        <div class="right1">
            <div class="title">
                <span id="rightYachtsName" runat="server"></span><span id="spanname" runat="server" style='color: red'></span>
            ...
            <div class="box6">
                ...
                <ul>
                    <asp:Repeater ID="Repeater2" runat="server">
                           ...
                           <ItemTemplate>
                        <li>
                             <img src='<%# "sys/uploadfile/Yachts_Layout/"+ Eval("LayoutPhoto") %>'  style="object-fit: contain; max-width:609px;"  alt="&quot;&quot;" />
